...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void startCurrentLocation(View view) {
        ...
        if (button.getText().equals(getResources().getString(R.string.pause))) {
            ...
            locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 5 * 1000, 10, locationListenerGPS);

            locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 5 * 1000, 10, locationListenerNetwork);
        ...
        public void onLocationChanged(Location location) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(MapsActivity.this, "Best Provider ", Toast.LENGTH_SHORT).show();
                }
            });
        }
